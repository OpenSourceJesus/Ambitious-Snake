...
namespace AmbitiousSnake.Analytics
{
	public class AnalyticsManager : SingletonMonoBehaviour<AnalyticsManager>
	{
		...
		public uint SessionNumber
		{
			get
			{
				return SaveAndLoadManager.GetValue<uint>("Session Number", 0);
			}
			set
			{
		...
		public float PreviousTotalGameplayDuration
		{
			get
			{
		...
		{
			PreviousTotalGameplayDuration += sessionTimer.TimeElapsed;
			SessionNumber ++;
		}
...
#region Analytics Events
		...
		public class AnalyticsEvent
		{
			...
			public AnalyticsDataEntry<string> eventName = new AnalyticsDataEntry<string>();
		...
		{
			public AnalyticsDataEntry<uint> score = new AnalyticsDataEntry<uint>();
...
#region Analytics Data Entries
		...
		[Serializable]
		public class GameVersionDataEntry : AnalyticsDataEntry<string>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
		...
		[Serializable]
		public class PlayerDataEntry : AnalyticsDataEntry<string>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
				return "";
		...
		[Serializable]
		public class SceneDataEntry : AnalyticsDataEntry<string>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
		...
		[Serializable]
		public class TotalGameplayDurationDataEntry : AnalyticsDataEntry<float>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
		...
		[Serializable]
		public class TimeSinceLastLogDataEntry : AnalyticsDataEntry<float>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
		...
		[Serializable]
		public class SessionNumberDataEntry : AnalyticsDataEntry<uint>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
		...
		[Serializable]
		public class SessionDurationDataEntry : AnalyticsDataEntry<float>
		{
			public override string GetValue (AnalyticsManager analyticsManager)
			{
