...
namespace BeautifyEffect {
				...
				public class Beautify : MonoBehaviour {
								...
								void OnRenderImage (RenderTexture source, RenderTexture destination) {
												...
												if (_depthOfField) {
																if (_depthOfFieldTargetFocus != null)
																				UpdateDepthOfFieldData (Vector2.zero);
								...
								void BlurThisDoF (RenderTexture rt, int renderPass) {
												...
												UpdateDepthOfFieldData (new Vector2 (0.44721f, -0.89443f));
												Graphics.Blit (rt, rt2, bMat, renderPass);
												UpdateDepthOfFieldData (new Vector2 (-1f, 0f));
								...
								public void UpdateMaterialProperties () {
												...
												if (_depthOfField)
																shaderKeywords.Add ("DEPTH_OF_FIELD");
								...
								void UpdateDepthOfFieldData (Vector2 blurDir) {
												...
												float d;
												if (_depthOfFieldTargetFocus != null) {
																Vector3 spos = cameraEffect.WorldToScreenPoint (_depthOfFieldTargetFocus.position);
																if (spos.z < 0)
																				d = cameraEffect.farClipPlane;
																else
																				d = spos.z;
												} else {
												...
												bMat.SetVector ("_BokehData", new Vector4 (dofPrevDistance, dofCoc, blurDir.x, blurDir.y));
												bMat.SetVector ("_BokehData2", new Vector4 (_depthOfFieldForegroundBlur ? _depthOfFieldForegroundDistance : cameraEffect.farClipPlane, _depthOfFieldMaxSamples, _depthOfFieldBokehThreshold, _depthOfFieldBokehIntensity));
								}
